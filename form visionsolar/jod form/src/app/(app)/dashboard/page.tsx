      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-mid-gray uppercase tracking-wider mb-1 group-hover/stat:text-vision-green transition-colors">Signatures Collected</p>
                <h3 className="text-4xl font-bold text-charcoal">{stats.totalSubmissions.toLocaleString()}</h3>
              </div>
              <div className="w-12 h-12 rounded-full bg-purple-50 flex items-center justify-center text-purple-500 group-hover/stat:bg-vision-green/10 group-hover/stat:text-vision-green transition-all">
